      ...
      <main role="main" style={{
        ...
        padding: '40px 20px'
          ...
          <h1 style={{
            ...
            AVA - Application Validation Assistant
          </h1>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '12px' }}>
            ...
            <div>
              <h3 style={{ margin: '0 0 8px 0', fontSize: '16px', fontWeight: '700', color: '#1a4480' }}>
                Upload Your Application Package (ZIP)
              </h3>
              <p style={{ margin: '0 0 8px 0', fontSize: '14px', color: '#1a4480', fontWeight: '600' }}>
                * Make sure the ZIP file name is formatted HRSA-YY-XXX. Meaning, YY is the fiscal year and XXX is the Funding Opportunity Number. Example: HRSA-26-091
              </p>
              <p style={{ margin: '0 0 12px 0', fontSize: '14px', color: '#1a4480', fontWeight: '600' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '14px', fontWeight: '600', color: '#1a4480' }}>SF-424</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="3" style={{ marginRight: '6px' }}>
                    <path d="M5 13l4 4L19 7" />
                  </svg>
                  <span style={{ fontSize: '14px', fontWeight: '600', color: '#1a4480' }}>Performance Site</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="3" style={{ marginRight: '6px' }}>
                    <path d="M5 13l4 4L19 7" />
                  </svg>
                  <span style={{ fontSize: '14px', fontWeight: '600', color: '#1a4480' }}>Supporting documents/attachments towards the Application page limit</span>
                </div>
              </div>
            </div>
          </div>
...
<svg width="120" height="40" viewBox="0 0 120 40" fill="none" style={{ margin: '0 auto' }}>
  ...
  <path d="M85 10 L100 20 L85 30" stroke="#1a4480" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
        ...
        >
          <input {...getInputProps()} aria-label="Upload ZIP file containing your application package" title="Upload ZIP file containing your application package" />
          ...
          {uploading ? (
            ...
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#1a4480', marginTop: '8px', fontWeight: '500' }}>
                Make sure the zip name is in the format HRSA-YY-XXX. Meaning, YY is the fiscal year and XXX is the funding opportunity number. Example: HRSA-26-091
              </p>
            </div>
          )}
        </div>
